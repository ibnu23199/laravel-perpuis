...
<div class="row">
    <div class="d-none d-md-block">
        ...
        <div class="row">
            <div class="col">
                <a class="btn btn-primary btn-sm btn-flat float-left" href="#"> <i class="fa fa-search"></i>
                    Hasil Pencarian : </a>
            </div>
        </div>
        <h6 class="mt-2"> Ditemukan " {{ $search->count() }} " hasil dari pencarian " {{ $cari }} "</h6>
        <div class="row mt-3">
            @if ($search->count() > 0 )
            @foreach ($search as $bk)
            <div class="col-md-3">
